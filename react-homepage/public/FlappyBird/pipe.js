...
function createPipe() {
    ...
    // set random pipe background color
    const randomColor = randomNumberBetween(0, 360);
    topElem.style.backgroundColor = `hsl(${randomColor}, 75%, 75%)`;
    bottomElem.style.backgroundColor = `hsl(${randomColor}, 75%, 75%)`;
